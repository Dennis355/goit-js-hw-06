...
const imgEl = document.querySelector('ul'); 
console.log(imgEl);


const imagesLiEl = images.map((imag) => `<li> <img width = 350px, height = 200px marginbottom = 100px src = ${imag.url} alt = ${imag.alt}> </li>`).join("");


imgEl.insertAdjacentHTML("beforeend", imagesLiEl);
...
// const imagesLiEl =  images.map(({url, alt}) => {
...
// imgEl.insertAdjacentHTML("beforeend", ...imagesLiEl),
// );
// // imgEl.append(...imagesLiEl); 

// // imgEl.insertAdjacentHTML("beforeend", ...imagesLiEl); 
// // console.log(imagesLiEl);
